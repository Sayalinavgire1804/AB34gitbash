...
public class AssignmentParallelTestingNetbanking {
	WebDriver driver;

	@Test
	@Parameters("browser")
	public void CreditCard(String nameofyourbrowser) throws InterruptedException 
	{
		...
		if(nameofyourbrowser.equals("Edge"))
		{
			...
			Thread.sleep(5000);
			int count1=banklist.size();
			System.out.println(count1);
			Thread.sleep(5000);
			banklist.get(count1-15).click();
