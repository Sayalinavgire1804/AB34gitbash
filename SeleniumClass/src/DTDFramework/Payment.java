...
class DTDGetuid1 {
   ...
   ChromeDriver driver;
	public  static void DTDMethod(String sayali ) throws EncryptedDocumentException, IOException
	{
...
@Test
	...
	cardnumber.sendKeys("568946390189");
	...
	WebElement creditcarddetails=driver.findElement(By.name("ppw-widgetEvent:AddCreditCardEvent"));
