...
@Test(groups={"Smoke"})
	 ...
	 public void sceanrio8() throws InterruptedException
	{
		...
		WebElement ship=driver.findElement(By.id("//input[@class='a-button-input'])[2]"));
		ship.click();
		Thread.sleep(3000);
	 ...
	 public void sceanrio9() throws InterruptedException
	{
		...
		checkout.click();
		Thread.sleep(3000);
		WebElement ship=driver.findElement(By.xpath("(//input[@class='a-button-input'])[2]"));
		ship.click();
		Thread.sleep(10000);
	...
	@Test(groups= {"Regression","System"})
	 public void sceanrio10() throws InterruptedException
	{
		 driver=new ChromeDriver();
        driver=new ChromeDriver();
		driver.get("https://www.amazon.in/");
		...
		ship.click();
		Thread.sleep(10000);
		WebElement netbanking=driver.findElement(By.xpath("(//input[@name='ppw-instrumentRowSelection'])[4]"));
		netbanking.click();
